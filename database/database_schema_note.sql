...
/*
MatKhau là một trường đặc biệt, ae sẽ lưu giá trị hash của mật khẩu sử dụng các thuật toán băm, độ dài 255 là tiêu chuẩn tối thiểu cho trường này
*/
...
/*
Đối với FK MaDanhMuc thì sẽ sử dụng hành vi mặc định, thường là "ON DELETE RESTRICT"
Để khi xóa một danh mục thì CSDL sẽ cấm hành vi này nếu còn tài khoản tham chiếu tới
*/
...
  `SoSlotDaBan` INT DEFAULT 0
);
/*
MatKhauSteam limit tới 255 cũng là để dự trù mã hóa, ae sẽ cần mã hóa thông tin này và giải mã khi bán cho khách
*/
...
/*
Đối với tài khoản game thì sẽ chỉ có 1 đơn hàng cho một tài khoản tại một thời điểm
Cơ chế chi tiết về vấn đề DONHANG có trong file CSDL_microShop_Hung
*/
