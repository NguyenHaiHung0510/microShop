...
(1, 2, 2500000, 1999000, 'DANG_BAN', 'Acc VIP Full Tướng Full Trang Phục, Rank Thách Đấu 100 Sao, 90 Bảng Ngọc', 1050, NOW() - INTERVAL 1 DAY, 'assets/images/root_images/home_lienquan.png');
...
-- Tài khoản 2
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(2, 2, 1000000, 750000, 'DANG_BAN', 'Rank Cao Thủ, 110 Tướng, 200 Trang Phục', 520, NOW() - INTERVAL 2 DAY, 'assets/images/root_images/home_lienquan.png');
INSERT INTO TAIKHOAN_LIENQUAN (MaTaiKhoan, TenDangNhap, MatKhau, HangRank, SoTuong, SoTrangPhuc, BacNgoc, LoaiDangKy) VALUES
(2, 'lq_caothu_01', 'matkhau123', 'Cao Thủ', 110, 200, 90, 'Facebook');

-- Tài khoản 3
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(3, 2, 500000, 399000, 'DANG_BAN', 'Rank Tinh Anh 1, Nhiều skin hiếm', 310, NOW() - INTERVAL 3 DAY, 'assets/images/root_images/home_lienquan.png');
INSERT INTO TAIKHOAN_LIENQUAN (MaTaiKhoan, TenDangNhap, MatKhau, HangRank, SoTuong, SoTrangPhuc, BacNgoc, LoaiDangKy) VALUES
(3, 'lq_tinhanh_re', 'matkhau123', 'Tinh Anh I', 90, 120, 90, 'Garena');

-- Tài khoản 4
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(4, 2, 200000, 150000, 'DANG_BAN', 'Acc Kim Cương, 70 tướng, 50 trang phục', 150, NOW() - INTERVAL 4 DAY, 'assets/images/root_images/home_lienquan.png');
INSERT INTO TAIKHOAN_LIENQUAN (MaTaiKhoan, TenDangNhap, MatKhau, HangRank, SoTuong, SoTrangPhuc, BacNgoc, LoaiDangKy) VALUES
(4, 'lq_kimcuong_1', 'matkhau123', 'Kim Cương II', 70, 50, 60, 'Garena');

-- Tài khoản 5
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(5, 2, 800000, 650000, 'DANG_BAN', 'Acc Cao Thủ, 105 Tướng, nhiều skin SSS', 430, NOW() - INTERVAL 5 DAY, 'assets/images/root_images/home_lienquan.png');
INSERT INTO TAIKHOAN_LIENQUAN (MaTaiKhoan, TenDangNhap, MatKhau, HangRank, SoTuong, SoTrangPhuc, BacNgoc, LoaiDangKy) VALUES
(5, 'lq_caothu_sss', 'matkhau123', 'Cao Thủ', 105, 180, 90, 'Garena');

-- Tài khoản 6
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(6, 2, 100000, 49000, 'DANG_BAN', 'Acc trắng thông tin, rank Vàng', 50, NOW() - INTERVAL 6 DAY, 'assets/images/root_images/home_lienquan.png');
INSERT INTO TAIKHOAN_LIENQUAN (MaTaiKhoan, TenDangNhap, MatKhau, HangRank, SoTuong, SoTrangPhuc, BacNgoc, LoaiDangKy) VALUES
(6, 'lq_trang_tt', 'matkhau123', 'Vàng I', 30, 10, 30, 'Facebook');

-- Tài khoản 7
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(7, 2, 300000, 220000, 'DANG_BAN', 'Full tướng, Rank Tinh Anh III', 222, NOW() - INTERVAL 7 DAY, 'assets/images/root_images/home_lienquan.png');
INSERT INTO TAIKHOAN_LIENQUAN (MaTaiKhoan, TenDangNhap, MatKhau, HangRank, SoTuong, SoTrangPhuc, BacNgoc, LoaiDangKy) VALUES
(7, 'lq_fulltuong_re', 'matkhau123', 'Tinh Anh III', 116, 80, 90, 'Garena');

-- Tài khoản 8
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(8, 2, 1500000, 1200000, 'DANG_BAN', 'Acc Sổ 1-20, nhiều skin hiếm, Cao Thủ', 600, NOW() - INTERVAL 8 DAY, 'assets/images/root_images/home_lienquan.png');
INSERT INTO TAIKHOAN_LIENQUAN (MaTaiKhoan, TenDangNhap, MatKhau, HangRank, SoTuong, SoTrangPhuc, BacNgoc, LoaiDangKy) VALUES
...
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(9, 1, 3000000, 2499000, 'DANG_BAN', 'Acc VIP Full Skin Súng, Có Thẻ Vô Cực, Rank Huyền Thoại', 1200, NOW() - INTERVAL 1 DAY, 'assets/images/root_images/home_freefire.jpg');
...
-- Tài khoản 10
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(10, 1, 500000, 350000, 'DANG_BAN', 'Rank Đại Cao Thủ, nhiều skin súng hiếm', 450, NOW() - INTERVAL 2 DAY, 'assets/images/root_images/home_freefire.jpg');
INSERT INTO TAIKHOAN_FREEFIRE (MaTaiKhoan, TenDangNhap, MatKhau, CoTheVoCuc, SoSkinSung, HangRank, LoaiDangKy) VALUES
(10, 'ff_daicaothu', 'matkhau123', 0, 40, 'Đại Cao Thủ', 'Facebook');

-- Tài khoản 11
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(11, 1, 200000, 149000, 'DANG_BAN', 'Acc giá rẻ, Rank Kim Cương, 20 skin súng', 210, NOW() - INTERVAL 3 DAY, 'assets/images/root_images/home_freefire.jpg');
INSERT INTO TAIKHOAN_FREEFIRE (MaTaiKhoan, TenDangNhap, MatKhau, CoTheVoCuc, SoSkinSung, HangRank, LoaiDangKy) VALUES
(11, 'ff_kimcuong_re', 'matkhau123', 0, 20, 'Kim Cương I', 'Google');

-- Tài khoản 12
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(12, 1, 1000000, 799000, 'DANG_BAN', 'Có Thẻ Vô Cực, Rank Huyền Thoại, 60 skin súng', 600, NOW() - INTERVAL 4 DAY, 'assets/images/root_images/home_freefire.jpg');
INSERT INTO TAIKHOAN_FREEFIRE (MaTaiKhoan, TenDangNhap, MatKhau, CoTheVoCuc, SoSkinSung, HangRank, LoaiDangKy) VALUES
(12, 'ff_vocuc_ht', 'matkhau123', 1, 60, 'Huyền Thoại', 'VK');

-- Tài khoản 13
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(13, 1, 80000, 49000, 'DANG_BAN', 'Acc trắng thông tin, Rank Vàng', 80, NOW() - INTERVAL 5 DAY, 'assets/images/root_images/home_freefire.jpg');
INSERT INTO TAIKHOAN_FREEFIRE (MaTaiKhoan, TenDangNhap, MatKhau, CoTheVoCuc, SoSkinSung, HangRank, LoaiDangKy) VALUES
(13, 'ff_trang_tt', 'matkhau123', 0, 5, 'Vàng II', 'Google');

-- Tài khoản 14
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(14, 1, 300000, 220000, 'DANG_BAN', 'Rank Cao Thủ, nhiều súng nâng cấp', 333, NOW() - INTERVAL 6 DAY, 'assets/images/root_images/home_freefire.jpg');
INSERT INTO TAIKHOAN_FREEFIRE (MaTaiKhoan, TenDangNhap, MatKhau, CoTheVoCuc, SoSkinSung, HangRank, LoaiDangKy) VALUES
(14, 'ff_sung_cap', 'matkhau123', 0, 35, 'Cao Thủ', 'Facebook');

-- Tài khoản 15
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(15, 1, 1500000, 1100000, 'DANG_BAN', 'Acc nhiều đồ, súng ống, rank Đại Cao Thủ', 510, NOW() - INTERVAL 7 DAY, 'assets/images/root_images/home_freefire.jpg');
INSERT INTO TAIKHOAN_FREEFIRE (MaTaiKhoan, TenDangNhap, MatKhau, CoTheVoCuc, SoSkinSung, HangRank, LoaiDangKy) VALUES
(15, 'ff_nhieudo_01', 'matkhau123', 0, 70, 'Đại Cao Thủ', 'VK');

-- Tài khoản 16
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(16, 1, 100000, 79000, 'DANG_BAN', 'Acc cùi rank Bạch Kim', 110, NOW() - INTERVAL 8 DAY, 'assets/images/root_images/home_freefire.jpg');
INSERT INTO TAIKHOAN_FREEFIRE (MaTaiKhoan, TenDangNhap, MatKhau, CoTheVoCuc, SoSkinSung, HangRank, LoaiDangKy) VALUES
...
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(17, 3, 5000000, 3999000, 'DANG_BAN', 'Acc VIP 1000+ Skin LMHT, Full Tướng, Rank Thách Đấu, Full Thú Cưng TFT', 2500, NOW() - INTERVAL 1 DAY, 'assets/images/root_images/home_lmht.jpg');
...
-- Tài khoản 18
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(18, 3, 1000000, 799000, 'DANG_BAN', 'Acc 300 Skin LMHT, Rank Cao Thủ, Nhiều tướng', 800, NOW() - INTERVAL 2 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
(18, 'riot_caothu_1', 'matkhau123', 300, 150, 300, 50, 30, 30, 'Cao Thủ', 'Khung Cao Thủ', 10, 5, 3);

-- Tài khoản 19
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(19, 3, 500000, 350000, 'DANG_BAN', 'Acc 150 Skin LMHT, Rank Kim Cương', 450, NOW() - INTERVAL 3 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
(19, 'riot_kimcuong_1', 'matkhau123', 200, 120, 150, 20, 10, 10, 'Kim Cương I', 'Khung Kim Cương', 5, 2, 1);

-- Tài khoản 20
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(20, 3, 150000, 99000, 'DANG_BAN', 'Acc Rank Vàng, 50 skin, 100 tướng', 200, NOW() - INTERVAL 4 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
(20, 'riot_vang_1', 'matkhau123', 100, 100, 50, 10, 5, 5, 'Vàng II', 'Khung Vàng', 1, 1, 0);

-- Tài khoản 21
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(21, 3, 2000000, 1500000, 'DANG_BAN', 'Acc 500 Skin, Full Tướng, Rank Đại Cao Thủ', 1100, NOW() - INTERVAL 5 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
(21, 'riot_daicaothu_500', 'matkhau123', 400, 168, 500, 100, 50, 50, 'Đại Cao Thủ', 'Khung Đại Cao Thủ', 20, 10, 5);

-- Tài khoản 22
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(22, 3, 50000, 29000, 'DANG_BAN', 'Acc Trắng thông tin, Level 30', 100, NOW() - INTERVAL 6 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
(22, 'riot_trang_tt', 'matkhau123', 30, 10, 2, 0, 0, 0, 'Chưa Rank', 'Không có', 0, 0, 0);

-- Tài khoản 23
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(23, 3, 250000, 180000, 'DANG_BAN', 'Acc 100 Skin, Rank Bạch Kim', 300, NOW() - INTERVAL 7 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
(23, 'riot_bachkim_100', 'matkhau123', 150, 110, 100, 15, 10, 10, 'Bạch Kim III', 'Khung Bạch Kim', 3, 1, 1);

-- Tài khoản 24
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(24, 3, 800000, 550000, 'DANG_BAN', 'Acc 250 Skin, nhiều skin Huyền Thoại', 650, NOW() - INTERVAL 8 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
(24, 'riot_huyen_thoai', 'matkhau123', 280, 140, 250, 40, 25, 25, 'Kim Cương IV', 'Khung Kim Cương', 8, 3, 2);

-- Tài khoản 25
INSERT INTO TAIKHOAN (MaTaiKhoan, MaDanhMuc, GiaGoc, GiaBan, TrangThai, DiemNoiBat, LuotXem, ThoiGianDang, DuongDanAnh) VALUES
(25, 3, 300000, 199000, 'DANG_BAN', 'Acc chuyên TFT, full Linh Thú, Sàn Đấu', 410, NOW() - INTERVAL 9 DAY, 'assets/images/root_images/home_lmht.jpg');
INSERT INTO TAIKHOAN_RIOT (MaTaiKhoan, TenDangNhap, MatKhau, CapDoRiot, SoTuongLMHT, SoTrangPhucLMHT, SoDaSacLMHT, SoBieuCamLMHT, SoBieuTuongLMHT, HangRankLMHT, KhungRankLMHT, SoThuCungTFT, SoSanDauTFT, SoChuongLucTFT) VALUES
...
(1, 'assets/images/root_images/home_lienquan.png'),
(1, 'assets/images/root_images/home_lmht.jpg'),
(1, 'assets/images/root_images/home_freefire.jpg'),
(1, 'assets/images/root_images/home_netflix.png'),
(1, 'assets/images/root_images/home_steam.jpg'),
(1, 'assets/images/root_images/home_youtube.jpg'),
(1, 'assets/images/root_images/sample_qr.png'),
(1, 'assets/images/root_images/home_lienquan.png'),
(1, 'assets/images/root_images/home_lmht.jpg'),
(1, 'assets/images/root_images/home_freefire.jpg'),
(1, 'assets/images/root_images/home_netflix.png'),
...
INSERT INTO ANH_TAIKHOAN (MaTaiKhoan, DuongDanAnh) VALUES
(2, 'assets/images/root_images/home_lienquan.png'), (2, 'assets/images/root_images/sample_qr.png'), (2, 'assets/images/root_images/home_steam.jpg'),
(3, 'assets/images/root_images/home_lienquan.png'), (3, 'assets/images/root_images/home_youtube.jpg'), (3, 'assets/images/root_images/home_lmht.jpg'),
(4, 'assets/images/root_images/home_lienquan.png'), (4, 'assets/images/root_images/home_freefire.jpg'), (4, 'assets/images/root_images/home_netflix.png'),
(5, 'assets/images/root_images/home_lienquan.png'), (5, 'assets/images/root_images/sample_qr.png'), (5, 'assets/images/root_images/home_steam.jpg'),
(6, 'assets/images/root_images/home_lienquan.png'), (6, 'assets/images/root_images/home_youtube.jpg'), (6, 'assets/images/root_images/home_lmht.jpg'),
(7, 'assets/images/root_images/home_lienquan.png'), (7, 'assets/images/root_images/home_freefire.jpg'), (7, 'assets/images/root_images/home_netflix.png'),
(8, 'assets/images/root_images/home_lienquan.png'), (8, 'assets/images/root_images/sample_qr.png'), (8, 'assets/images/root_images/home_steam.jpg');

-- Ảnh cho TK 9 (Đặc biệt - 15 ảnh)
INSERT INTO ANH_TAIKHOAN (MaTaiKhoan, DuongDanAnh) VALUES
(9, 'assets/images/root_images/home_freefire.jpg'),
(9, 'assets/images/root_images/home_freefire.jpg'),
(9, 'assets/images/root_images/home_freefire.jpg'),
(9, 'assets/images/root_images/home_netflix.png'),
(9, 'assets/images/root_images/home_steam.jpg'),
(9, 'assets/images/root_images/home_youtube.jpg'),
(9, 'assets/images/root_images/sample_qr.png'),
(9, 'assets/images/root_images/home_freefire.jpg'),
(9, 'assets/images/root_images/home_lmht.jpg'),
(9, 'assets/images/root_images/home_freefire.jpg'),
(9, 'assets/images/root_images/home_netflix.png'),
(9, 'assets/images/root_images/home_steam.jpg'),
(9, 'assets/images/root_images/home_youtube.jpg'),
...
INSERT INTO ANH_TAIKHOAN (MaTaiKhoan, DuongDanAnh) VALUES
(10, 'assets/images/root_images/home_freefire.jpg'), (10, 'assets/images/root_images/sample_qr.png'), (10, 'assets/images/root_images/home_netflix.png'),
(11, 'assets/images/root_images/home_freefire.jpg'), (11, 'assets/images/root_images/home_youtube.jpg'), (11, 'assets/images/root_images/home_lmht.jpg'),
(12, 'assets/images/root_images/home_freefire.jpg'), (12, 'assets/images/root_images/home_lienquan.png'), (12, 'assets/images/root_images/home_steam.jpg'),
(13, 'assets/images/root_images/home_freefire.jpg'), (13, 'assets/images/root_images/sample_qr.png'), (13, 'assets/images/root_images/home_netflix.png'),
(14, 'assets/images/root_images/home_freefire.jpg'), (14, 'assets/images/root_images/home_youtube.jpg'), (14, 'assets/images/root_images/home_lmht.jpg'),
(15, 'assets/images/root_images/home_freefire.jpg'), (15, 'assets/images/root_images/home_lienquan.png'), (15, 'assets/images/root_images/home_steam.jpg'),
(16, 'assets/images/root_images/home_freefire.jpg'), (16, 'assets/images/root_images/sample_qr.png'), (16, 'assets/images/root_images/home_netflix.png');

-- Ảnh cho TK 17 (Đặc biệt - 15 ảnh)
INSERT INTO ANH_TAIKHOAN (MaTaiKhoan, DuongDanAnh) VALUES
(17, 'assets/images/root_images/home_lmht.jpg'),
(17, 'assets/images/root_images/home_lmht.jpg'),
(17, 'assets/images/root_images/home_lmht.jpg'),
(17, 'assets/images/root_images/home_lienquan.png'),
(17, 'assets/images/root_images/home_freefire.jpg'),
(17, 'assets/images/root_images/home_netflix.png'),
(17, 'assets/images/root_images/home_steam.jpg'),
(17, 'assets/images/root_images/home_youtube.jpg'),
(17, 'assets/images/root_images/sample_qr.png'),
(17, 'assets/images/root_images/home_lmht.jpg'),
(17, 'assets/images/root_images/home_lienquan.png'),
(17, 'assets/images/root_images/home_freefire.jpg'),
(17, 'assets/images/root_images/home_netflix.png'),
...
INSERT INTO ANH_TAIKHOAN (MaTaiKhoan, DuongDanAnh) VALUES
(18, 'assets/images/root_images/home_lmht.jpg'), (18, 'assets/images/root_images/sample_qr.png'), (18, 'assets/images/root_images/home_steam.jpg'),
(19, 'assets/images/root_images/home_lmht.jpg'), (19, 'assets/images/root_images/home_youtube.jpg'), (19, 'assets/images/root_images/home_lienquan.png'),
(20, 'assets/images/root_images/home_lmht.jpg'), (20, 'assets/images/root_images/home_freefire.jpg'), (20, 'assets/images/root_images/home_netflix.png'),
(21, 'assets/images/root_images/home_lmht.jpg'), (21, 'assets/images/root_images/sample_qr.png'), (21, 'assets/images/root_images/home_steam.jpg'),
(22, 'assets/images/root_images/home_lmht.jpg'), (22, 'assets/images/root_images/home_youtube.jpg'), (22, 'assets/images/root_images/home_lienquan.png'),
(23, 'assets/images/root_images/home_lmht.jpg'), (23, 'assets/images/root_images/home_freefire.jpg'), (23, 'assets/images/root_images/home_netflix.png'),
(24, 'assets/images/root_images/home_lmht.jpg'), (24, 'assets/images/root_images/sample_qr.png'), (24, 'assets/images/root_images/home_steam.jpg'),
(25, 'assets/images/root_images/home_lmht.jpg'), (25, 'assets/images/root_images/home_youtube.jpg'), (25, 'assets/images/root_images/home_lienquan.png');
...
VALUES (
  ...
  320,
  '8X2kIfS6fb8',
  'assets/images/root_images/steam_cyberpunk_detail.jpg' );
...
VALUES (
  ...
  500,
  'E3Huy2cdih0',
  'assets/images/root_images/steam_elden_ring_detail.jpg');
INSERT INTO BAIVIET_GIOITHIEU (MaGameSteam, TieuDeBaiViet, NoiDung)
...
VALUES (
  ...
  700,
  'eaW0tYpxyp0',
  'assets/images/root_images/steam_red_dead_redemption_detail.jpg' );
INSERT INTO BAIVIET_GIOITHIEU (MaGameSteam, TieuDeBaiViet, NoiDung)
...
VALUES (
  ...
  450,
  'Id2EaldBaWw',
  'assets/images/root_images/steam_resident_evil_4_remake_detail.jpg' );
INSERT INTO BAIVIET_GIOITHIEU (MaGameSteam, TieuDeBaiViet, NoiDung)
...
VALUES (
  ...
  250,
  'UAO2urG23S4',
  'assets/images/root_images/steam_hollow-knight-detail.jpg' );
INSERT INTO BAIVIET_GIOITHIEU (MaGameSteam, TieuDeBaiViet, NoiDung)
...
VALUES (
  ...
  640,
  '1T22wNvoNiU',
  'assets/images/root_images/steam_baldur_gate_3_detail.jpg' );
INSERT INTO BAIVIET_GIOITHIEU (MaGameSteam, TieuDeBaiViet, NoiDung)
...
VALUES (
  ...
  900,
  'ot7uXNQskhs',
  'assets/images/root_images/steam_stardew_valley_detail.jpg' );
INSERT INTO BAIVIET_GIOITHIEU (MaGameSteam, TieuDeBaiViet, NoiDung)
...
VALUES (
  ...
  1500,
  'QkkoHAzjnUs',
  'assets/images/root_images/steam_gta_5_detail.jpg' );
INSERT INTO BAIVIET_GIOITHIEU (MaGameSteam, TieuDeBaiViet, NoiDung)
