    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <body>
                ...
                <% // Lấy đối tượng NguoiDung từ Session NguoiDung user=(NguoiDung)
                    session.getAttribute("user"); %>
                    <% // Lấy tên hạng thành viên String tenHTV=(String)
                        request.getAttribute("HangNguoiDung"); %>
                        ...
                        <div class="profile-container">
                            ...
                            <div class="profile-info">
                                ...
                                <p><strong>SĐT:</strong>
                                    <%= (user.getSoDienThoai() !=null && !user.getSoDienThoai().isEmpty()) ?
                                        user.getSoDienThoai() : "(Chưa cập nhật)" %>
                                </p>
                                <p><strong>Tổng tiền đã chi:</strong>
                                    <%= user.getTongTienDaChi() %>
                                </p>
                                <p><strong>Hạng Thành Viên:</strong>
                                    <%= (tenHTV !=null) ? tenHTV : "(Chưa có hạng)" %>
                                </p>
                            </div>
                            ...
                            <div class="profile-links">
                                ...
                                <a href="${pageContext.request.contextPath}/profile/view-account">Xem Tài Khoản Đã
                                    Mua</a>
                            </div>
                            ...
                            <div style="text-align: center;">
                                <a href="${pageContext.request.contextPath}/profile/edit" class="btn-update"
