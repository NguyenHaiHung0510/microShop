...
<div class="container">
    ...
    <c:if test="${empty requestScope.purchasedAccounts}">
        <p style="text-align: center;">Bạn chưa mua tài khoản nào.</p>
    </c:if>
            ...
            <tbody>
                ...
                <c:forEach var="tk" items="${requestScope.purchasedAccounts}">
                    <tr>
                        <td>#${tk.maTaiKhoan}</td>
                        <td>${tk.diemNoiBat}</td>
                        <td><fmt:formatNumber value="${tk.giaBan}" type="currency" currencyCode="VND" maxFractionDigits="0"/> VNĐ</td>
